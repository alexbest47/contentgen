...
const categories = [
  ...
  },
  {
    ...
    variables: [
      ...
      { name: "{{letter_theme}}", description: "Свободное описание цели и содержания письма (шаблон «С нуля»). Пользователь описывает что хочет в письме — цель, ключевые мысли, тон, ссылки", source: "email_letters.letter_theme_description (ввод на шаге 4 визарда)" },
    ],
  },
  {
    title: "Лид-магниты",
