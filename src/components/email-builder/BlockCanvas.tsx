          ...
          {blocks.map((block, idx) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                {/* Banner image placeholder for generated blocks */}
                {isGeneratedBlock(block.block_type) && block.config.mode === "text_image" && !block.banner_image_url && block.generated_html && (
                  <div className="mt-2 bg-muted rounded-md p-6 text-center text-sm text-muted-foreground">
